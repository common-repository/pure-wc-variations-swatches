 ...
 * Start at version 1.1.7 and use SemVer - https://semver.org
 * Rename this for your plugin and update it as you release new versions.
 */
define( 'TP_WVS_VERSION', '1.1.7' );
...
if( !function_exists('pure_swatches_admin') ){
    function pure_swatches_admin(){
        if( !isset($GLOBALS['pure_swatches_admin_object']) ){
            $GLOBALS['pure_swatches_admin_object'] = new Tp_Wvs_Admin('pure-wc-swatches', '1.1.7');
        }
